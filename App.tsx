              ...
              return (
                <Pressable
                  ...
                  onPress={() => {
                    ...
                    // Badges individueel wissen bij openen van die specifieke chat — niet bulk hier
                  }}
...
<View style={{ marginTop: isWebPlatform ? 10 : 6, marginBottom: isWebPlatform ? 18 : 14, gap: 10 }}>
        ...
        </View>{/* end pre-timeline wrapper */}

        <View style={{ backgroundColor: theme.bg, paddingHorizontal: isWebPlatform ? 20 : 14, paddingBottom: 8 }}>
        ...
        </View>{/* end post-timeline wrapper */}
